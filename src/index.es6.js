 ...
 * @param $0[3] onMount {function} a callback to be called with the node reference once the node has been added to it's
 * parent
 *
 ...
 * @name mount
 * @param parrent {Node} the parent node to append to
